// Code auto-converted by Control Freak 2 on Friday, November 22, 2019!
...
public class DrawingManager : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        mousePointer.GetComponent<TargetJoint2D>().target = (Vector2)Camera.main.ScreenToWorldPoint(ControlFreak2.CF2Input.mousePosition);
    }
...
Mathf.Infinity, layerMask);
        ...
        mouseRay = Physics2D.Raycast((Vector2)Camera.main.ScreenToWorldPoint(ControlFreak2.CF2Input.mousePosition), Vector2.zero,
Mathf.Infinity, layerMask);
        ...
        if (ControlFreak2.CF2Input.GetMouseButtonDown(0))
        {
            ...
            if (canDraw == true)
            {
                mousePointer.transform.position = Camera.main.ScreenToWorldPoint(ControlFreak2.CF2Input.mousePosition);
